package net.henbit.raytracing.life.chapter10;
...
public class Chapter10
{
    ...
    private Vector3 rayColor(final Ray r, final Vector3 background, Hittable world, Hittable lights, int depth)
    {
        ...
        PDF p0 = new HittablePDF(lights, hitRecord.point);
        PDF p1 = new CosinePDF(hitRecord.normal);
        MixturePDF mixturePDF = new MixturePDF(p0, p1);

        scattered = new Ray(hitRecord.point, mixturePDF.generate(), r.time());
    ...
    public void run() throws IOException
    {
        ...
        Hittable lights = new XZRect(213, 343, 227, 332, 554, new Material()
        {
        });
