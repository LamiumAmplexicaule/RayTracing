...
public class Chapter11
{
    ...
    public void run() throws IOException
    {
        ...
        // Camera
        Camera camera = new Camera(new Vector3(-2, 2, 1), new Vector3(0, 0, -1), new Vector3(0, 1, 0), 90, aspectRatio);
//        Camera camera = new Camera(new Vector3(-2, 2, 1), new Vector3(0, 0, -1), new Vector3(0, 1, 0), 20, aspectRatio);
